...
namespace Pages.AnnPages
{
    ...
    public class AccountHomePage : SuperPage
    {
        ...
        #region IWebElements
        private IWebElement ChangePasswordBtn => driver.FindElement(By.CssSelector("body > div.container.me-body-container > div.row > div.col-xs-12 > div:nth-child(1) > div > div > p:nth-child(7) > a"));
